...
-- Source Path: MATE_HDLsolver_myFirstCircuit/ForFPGA/nfp_mul_single
-- Hierarchy Level: 2
-- 
...
ARCHITECTURE rtl OF nfp_mul_single IS
  ...
  SIGNAL Delay22_reg                      : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Delay4_reg <= (OTHERS => to_unsigned(0, 48));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay11_reg(0) <= Logical_Operator2_out1_1;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay10_reg <= (OTHERS => to_signed(16#000#, 10));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay10_reg(0) <= Switch2_out1_1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Delay22_reg(2 DOWNTO 1) <= Delay22_reg(1 DOWNTO 0);
      END IF;
    END IF;
  ...
  Switch6_out1 <= Constant6_out1 WHEN Relational_Operator_out1 = '0' ELSE
      Switch4_out1;
