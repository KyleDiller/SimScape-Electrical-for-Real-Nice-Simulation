...
-- -------------------------------------------------------------
-- 
-- Module: nfp_convert_sfix_32_En0_to_single
-- Source Path: MATE_HDLsolver_myFirstCircuit/ForFPGA/PWM Generator/Discrete Triangular-Waveform Generator/nfp_convert_sfix_32_En0_to_single
-- Hierarchy Level: 3
-- 
...
ENTITY nfp_convert_sfix_32_En0_to_single IS
...
END nfp_convert_sfix_32_En0_to_single;


ARCHITECTURE rtl OF nfp_convert_sfix_32_En0_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(31 DOWNTO 0);  -- int32
  SIGNAL Delay_out1                       : signed(31 DOWNTO 0);  -- sfix32
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL Unary_Minus_in0                  : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL Unary_Minus_out1                 : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL Unary_Minus_out1_dtc             : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL Switch_out1                      : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(0, 32) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(0, 32) ELSE
      '0';
  ...
  Unary_Minus_in0 <=  - (resize(Delay_out1, 33));
  Unary_Minus_out1 <= Unary_Minus_in0(31 DOWNTO 0);
