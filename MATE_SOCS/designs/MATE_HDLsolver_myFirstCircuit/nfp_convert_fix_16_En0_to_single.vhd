...
-- -------------------------------------------------------------
-- 
-- Module: nfp_convert_fix_16_En0_to_single
-- Source Path: MATE_HDLsolver_myFirstCircuit/ForFPGA/PWM Generator/Discrete Triangular-Waveform Generator/nfp_convert_fix_16_En0_to_single
-- Hierarchy Level: 3
-- 
...
ENTITY nfp_convert_fix_16_En0_to_single IS
...
END nfp_convert_fix_16_En0_to_single;


ARCHITECTURE rtl OF nfp_convert_fix_16_En0_to_single IS

  -- Signals
  SIGNAL nfp_in_unsigned                  : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL Delay_out1                       : unsigned(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL Data_Type_Conversion1_out1       : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL Unary_Minus_cast                 : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL Unary_Minus_cast_1               : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL Unary_Minus_cast_2               : signed(16 DOWNTO 0);  -- sfix17
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_unsigned(16#0000#, 16) ELSE
      '0';
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay5_reg(0) <= CompareToZero1_out1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay4_reg(0) <= Logical_Operator_out1;
  ...
  Data_Type_Conversion1_out1 <= signed(Delay_out1);

  Unary_Minus_cast <= unsigned(Data_Type_Conversion1_out1);
  Unary_Minus_cast_1 <= signed(resize(Unary_Minus_cast, 17));
  Unary_Minus_cast_2 <=  - (Unary_Minus_cast_1);
  Unary_Minus_out1 <= unsigned(Unary_Minus_cast_2(15 DOWNTO 0));

  
  Switch_out1 <= Delay_out1 WHEN Logical_Operator_out1 = '0' ELSE
      Unary_Minus_out1;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay2_reg <= (OTHERS => to_unsigned(0, 128));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
