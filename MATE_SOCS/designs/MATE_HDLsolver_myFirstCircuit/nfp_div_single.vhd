...
-- Source Path: MATE_HDLsolver_myFirstCircuit/ForFPGA/PWM Generator/Discrete Triangular-Waveform Generator/nfp_div_single
-- Hierarchy Level: 3
-- 
...
ARCHITECTURE rtl OF nfp_div_single IS
  ...
  SIGNAL mant_a_norm_mant_b_norm_out1     : std_logic;  -- ufix1
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay1_out1_1 <= Bit_Concat1_out1_1;
      END IF;
    END IF;
  ...
  mant_a_norm_mant_b_norm_out1 <= '1' WHEN Delay2_out1 < Delay1_out1_1 ELSE
      '0';
  ...
  if_mant_a_norm_mant_b_norm_out1 <= DTC_out1 WHEN mant_a_norm_mant_b_norm_out1 = '0' ELSE
  ...
  if_mant_a_norm_mant_b_norm_1_out1 <= reinterpretcast_bitconcat_fi_0_out1 WHEN mant_a_norm_mant_b_norm_out1 = '0' ELSE
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay3_out1_3 <= if_mant_a_norm_mant_b_norm_1_out1;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay2_out1_1 <= Unary_Minus2_out1;
      END IF;
    END IF;
  ...
  Bit_Concat_out1_1 <= unsigned'(C_out1_3 & Logical_Operator_out1_1);

  Delay_P7_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P7_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P7_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P9_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P9_10_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P11_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P11_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P11_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P13_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P13_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P13_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P15_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P15_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P17_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P17_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P17_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P19_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P19_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P19_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P21_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P21_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P21_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P23_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P23_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P23_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P25_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P25_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P27_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P27_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P27_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P29_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay_P29_2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
